...
def calculate_surprisal_for_story(model, tokenizer, word_list):
    """
    Calculates token-level surprisal for a list of words using a sliding window.
    Maps token surprisals back to original word boundaries via character offsets.
    """
...
def run_pipeline():
    """
    Loads story data and iterates through specified LLMs to calculate and save surprisal scores.
    """
    try:
